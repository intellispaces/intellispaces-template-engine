package tech.intellispaces.framework.templateengine.template.expression.compilation;
...
public class ExpressionClassLoader extends ClassLoader {
  ...
  public ExpressionClassLoader(
      List<CompiledFileObject> snippetFileObjects, ClassLoader parentClassLoader
  ) {
