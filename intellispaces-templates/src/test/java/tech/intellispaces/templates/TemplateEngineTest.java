...
public class TemplateEngineTest {
  ...
  public void testDemo() throws Exception {
    // Given
    String source = ResourceFunctions.readResourceAsString(TemplateEngineTest.class, "/demo.template").orElseThrow();
    ...
    // When
    Template template = TemplateEngine.of(source);
    String result = template.resolve(variables);

    // Then
    assertThat(result).isEqualTo(ResourceFunctions.readResourceAsString(TemplateEngineTest.class, "/demo.result").orElseThrow());
  }
