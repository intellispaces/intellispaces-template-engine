...
import intellispaces.templates.expression.value.ListValue;
import intellispaces.templates.expression.value.MapValue;
import intellispaces.templates.expression.value.StringValue;
