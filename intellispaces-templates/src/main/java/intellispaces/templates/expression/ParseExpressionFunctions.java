...
import intellispaces.templates.expression.compilation.CompileFunctions;
import intellispaces.templates.expression.value.BooleanValues;
import intellispaces.templates.expression.value.IntegerValues;
import intellispaces.templates.expression.value.ListValues;
import intellispaces.templates.expression.value.MapValues;
import intellispaces.templates.expression.value.RealValues;
import intellispaces.templates.expression.value.StringValues;
import intellispaces.templates.expression.value.Value;
import intellispaces.templates.expression.value.VoidValues;
