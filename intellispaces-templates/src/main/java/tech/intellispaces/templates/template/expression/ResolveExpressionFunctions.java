...
import tech.intellispaces.templates.template.expression.value.ListValue;
import tech.intellispaces.templates.template.expression.value.MapValue;
import tech.intellispaces.templates.template.expression.value.StringValue;
