...
import tech.intellispaces.templates.expression.compilation.CompileFunctions;
import tech.intellispaces.templates.expression.value.BooleanValues;
import tech.intellispaces.templates.expression.value.IntegerValues;
import tech.intellispaces.templates.expression.value.ListValues;
import tech.intellispaces.templates.expression.value.MapValues;
import tech.intellispaces.templates.expression.value.RealValues;
import tech.intellispaces.templates.expression.value.StringValues;
import tech.intellispaces.templates.expression.value.Value;
import tech.intellispaces.templates.expression.value.VoidValues;
