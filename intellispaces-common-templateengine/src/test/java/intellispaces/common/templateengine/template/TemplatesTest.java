...
import intellispaces.common.resource.ResourceFunctions;
...
public class TemplatesTest {
  ...
  public void testDemo() throws Exception {
    // Given
    String source = ResourceFunctions.readResourceAsString(TemplatesTest.class, "/demo.template").orElseThrow();
    ...
    // Then
    assertThat(result).isEqualTo(ResourceFunctions.readResourceAsString(TemplatesTest.class, "/demo.result").orElseThrow());
  }
  ...
  public void testTemplate_whenOneLineText() throws Exception {
    ...
    // When
    Template template = Templates.of(source);
    String result = template.resolve(Map.of());
  ...
  public void testTemplate_whenWhenStatement_andThreeBranches() throws Exception {
    ...
    // When
    Template template = Templates.of(source);
    String result = template.resolve(Map.of("str", "b"));
